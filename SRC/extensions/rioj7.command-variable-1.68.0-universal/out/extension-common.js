...
let showErrMsg = true;
function setShowErrMsg$1(b) { showErrMsg = b; }
...
function errorMessage(msg, noObject) {
  if (getShowErrMsg()) { vscode$1.window.showErrorMessage(msg); }
...
var utils$1 = {
  getProperty, getDefaultProperty, errorMessage, setShowErrMsg: setShowErrMsg$1, fileNotInFolderError, isString, isArray, isObject, range, dblQuest, nUp, utf8_to_str, str_to_utf8_array, cleanJSONString
};
