...
* Update OmniSharp to 1.39.2 (PR: [#5319](https://github.com/muhammadsammy/free-omnisharp-vscode/blob/HEAD/<TODO>))
...
* Fixed a typo in tasks.json (PR: [1945](https://github.com/OmniSharp/omnisharp-vscode/pull/1945)) _(Contributed by [@SebastianPfliegel](https://github.com/muhammadsammy/free-omnisharp-vscode/blob/HEAD/SebastianPfliegel))_
...
* Don't offer to generate tasks.json if build task already exists. (PR [#1363](https://github.com/muhammadsammy/free-omnisharp-vscode/issues/1363)) _(Contributed by [@eamodio](https://github.com/eamodio))_
