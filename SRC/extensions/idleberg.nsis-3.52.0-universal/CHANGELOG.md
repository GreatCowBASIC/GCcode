...
- stricter checks (hopefully fixing [#5](https://github.com/idleberg/vscode-nsis/issues/5))
...
- add [Output Channel](https://code.visualstudio.com/Docs/extensionAPI/vscode-api#OutputChannel) support for build commands (closes [#4](https://github.com/idleberg/vscode-nsis/issues/4))
